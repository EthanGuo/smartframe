...
class TestGroup(unittest.TestCase):
    ...
    def __insertGroup(self):
        data = {'groupname': 'test', 'gid': 5, 'members': [{'uid': 0, 'role': 10}, {'uid': 1, 'role': 9}, {'uid': 2, 'role': 8}]}
    ...
    def testdelGroupMembers(self):
        ...
        self.assertTrue(Members[2]['role'] == 8)

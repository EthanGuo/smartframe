...
def testAccountWithOutUidAPI():
    url = 'http://127.0.0.1:8080/smartapi/account'
    register= {
             'subc':'register', 
             'data':{'username': 'test', 'password': '1234', 'appid': '01', 'info': {'email': 'spritegzq@gmail.com'}}
            }
    forgotpasswd = {
             'subc':'forgotpasswd', 
    ...
    login = {
             'subc':'login', 
             'data':{'appid': '03', 'info':{'company':'borqs','email': 'spritegzq@gmail.com', 'phonenumber':'12121'}, 'username': 'GUO', 'password': 'e10adc3949ba59abbe56e057f20f883e'}
            }     
    headers = {'content-type' : 'application/json'}
    r = requests.post(url=url, data=json.dumps(register), headers=headers)
...
def testAccountWithUidAPI():
    url = 'http://127.0.0.1:8080/smartapi/user/351f021bc0e143bf71b17e33c1547f70'
    changepasswd = {
             'subc':'changepasswd', 
